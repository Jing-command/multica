...
const deleteVerificationCodeByID = `-- name: DeleteVerificationCodeByID :exec
DELETE FROM verification_code
WHERE id = $1
`

func (q *Queries) DeleteVerificationCodeByID(ctx context.Context, id pgtype.UUID) error {
	_, err := q.db.Exec(ctx, deleteVerificationCodeByID, id)
	return err
}
